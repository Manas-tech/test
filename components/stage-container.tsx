...
export default function StageContainer({ stage, allStages }: Props) {
  ...
  return (
    <div className={styles.container}>
              ...
              <div className={cn(styles.bottom, styleUtils.appear, styleUtils['appear-second'])}>
                ...
                >
                  ...
                  >
                    <path
                      fill="white"
                      d="M104.4 103.9c-5.7 0-10.2 5-10.2 11.1s4.6 11.1 10.2 11.1c5.7 0 10.2-5 10.2-11.1.1-6.1-4.5-11.1-10.2-11.1-11.1zm36.5 0c-5.7 0-10.2 5-10.2 11.1s4.6 11.1 10.2 11.1c5.7 0 10.2-5 10.2-11.1s-4.5-11.1-10.2-11.1z"
                    />
                    <path
                      fill="white"
      ...
      {stage.isLive && isConnected && <Sidebar allStages={allStages} />}
    </div>
  );
}
