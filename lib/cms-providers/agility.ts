  ...
  const lst: Stage[] = stages
    ...
    .map((stage: any) => {
      ...
      return {
        ...
        isLive: stage.fields.isLive || false,
        roomId: stage.fields.roomId || '',
        stagePeers: stage.fields.stagePeers || [],
        backstagePeers: stage.fields.backstagePeers || [],
        schedule
      };
    });
...
export async function getAllSponsors(): Promise<Sponsor[]> {
  ...
  return lst.sort((a, b) => a.name.localeCompare(b.name, undefined, { sensitivity: 'base' }));
}
